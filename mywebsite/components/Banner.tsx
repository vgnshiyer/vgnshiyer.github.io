...
const Banner = () => {
    return (
        <div className="flex flex-col sm:flex-row justify-between items-center p-4 mb-10">
            <div className="ml-0 sm:ml-6 md:ml-12 lg:ml-16">
                <h1 className="text-3xl lg:text-4xl pl-6 mb-1 font-bold text-white">Hello 👋</h1>
